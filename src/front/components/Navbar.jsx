            ...
            <div className="container-fluid flex-nowrap">
                <div className="d-flex align-items-center gap-4">
                    ...
                    <div className="d-none d-md-flex gap-3 text-secondary" style={{ fontSize: "14px" }}>
                        ...
                        {/* MODIFICACIÓN: Nav Item 2 ahora apunta a la gestión de clínicas */}
                        <Link to="/admin/clinicas" className="text-primary text-decoration-underline cursor-pointer">Gestión de Clínicas</Link>
                        ...
                        <Link to="/invoice" className="text-primary text-decoration-underline cursor-pointer">Generar Recibo</Link>
